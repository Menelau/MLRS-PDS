...
def random_forest(x_train, y_train, model_name):
    ...
    pkl_filename = "models_f/{}/split_{}/random_forest.pkl".format(portion, split_num)
...
def bagging_with_decision_tree(x_train, y_train, model_name):
    ...
    pkl_filename = "models_f/{}/split_{}/bagging_with_decision_tree.pkl".format(portion, split_num)
    with open(pkl_filename, 'wb') as file:
        pickle.dump(model, file)
...
def boosting_with_decision_tree(x_train, y_train, model_name):
    ...
    pkl_filename = "models_f/{}/split_{}/boosting_with_decision_tree.pkl".format(portion, split_num)
    with open(pkl_filename, 'wb') as file:
        pickle.dump(model, file)
...
def Boosting_with_perceptron(x_train, y_train, model_name):
    ...
    pkl_filename = "models_f/{}/split_{}/boosting_with_perceptron.pkl".format(portion, split_num)
    with open(pkl_filename, 'wb') as file:
        pickle.dump(model, file)
